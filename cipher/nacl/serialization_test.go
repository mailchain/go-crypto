...
func Test_serializePublicKeyEncryptedContent(t *testing.T) {
	type args struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := serializePublicKeyEncryptedContent(tt.args.data, tt.args.pubKey)
			if (err != nil) != tt.wantErr {
				t.Errorf("serializePublicKeyEncryptedContent() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if !assert.Equal(t, tt.want, got) {
				t.Errorf("serializePublicKeyEncryptedContent() = %v, want %v", got, tt.want)
			}
...
func Test_deserializePublicKeyEncryptedContent(t *testing.T) {
	type args struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			gotCph, gotPubKey, err := deserializePublicKeyEncryptedContent(tt.args.raw)
			if (err != nil) != tt.wantErr {
				t.Errorf("deserializePublicKeyEncryptedContent() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if !assert.Equal(t, tt.wantCph, gotCph) {
				t.Errorf("deserializePublicKeyEncryptedContent() gotCph = %v, want %v", gotCph, tt.wantCph)
			}
			if !assert.Equal(t, tt.wantPubKey, gotPubKey) {
				t.Errorf("deserializePublicKeyEncryptedContent() gotPubKey = %v, want %v", gotPubKey, tt.wantPubKey)
			}
		})
	}
}

func Test_serializePublicKeyEncryptedContentEndToEnd(t *testing.T) {
	type args struct {
		data   cipher.EncryptedContent
		pubKey crypto.PublicKey
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			encoded, err := serializePublicKeyEncryptedContent(tt.args.data, tt.args.pubKey)
			if (err != nil) != tt.wantErr {
				t.Errorf("serializePublicKeyEncryptedContent() error = %v, wantErr %v", err, tt.wantErr)
				return
			}

			decoded, pubKey, err := deserializePublicKeyEncryptedContent(encoded)
			if (err != nil) != tt.wantErr {
				t.Errorf("deserializePublicKeyEncryptedContent() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
...
func Test_serializePrivateKeyEncryptedContent(t *testing.T) {
	type args struct {
		sealedBox cipher.EncryptedContent
		keyID     byte
	}
	tests := []struct {
		name string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			assert.Equal(t, tt.want, serializePrivateKeyEncryptedContent(tt.args.sealedBox, tt.args.keyID))
		})
	}
}

func Test_deserializePrivateKeyEncryptedContent(t *testing.T) {
	type args struct {
		raw cipher.EncryptedContent
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			gotCph, gotKeyID, err := deserializePrivateKeyEncryptedContent(tt.args.raw)
			tt.assertion(t, err)
			assert.Equal(t, tt.wantCph, gotCph)
